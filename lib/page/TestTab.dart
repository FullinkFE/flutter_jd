...
class TestTb extends StatefulWidget {
  @override
...
class HomeState extends State<TestTb> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    mTabController.addListener(() {
      ...
      if (mTabController.indexIsChanging) {
        //判断TabBar是否切换
        print("mTabController in ${mTabController.index}");
